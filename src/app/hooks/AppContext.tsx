...
const AppProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const [inforPage, setInforPage] = useState<PagesInterface>(defaultInforPage)
  const [account, setAccount] = useState<typeAccountUser>(defaulAccountUser)
